...
Input: `data/processed/timed_eval_stage10_abort_regression.jsonl`
Gate: **FAIL**
...
| expected_act_hit | 5/8 (62.5%) | >= 85.0% |
...
| wall_p50 | 21.7s | <= 20.0s |
| wall_p90 | 27.1s | <= 30.0s |
...
- rows 8 < 100
- expected_act_hit_pct 62.5 < 85.0
- usable_answer_pct 12.5 < 85.0
- wall_p50_ms 21725.1 > 20000.0
