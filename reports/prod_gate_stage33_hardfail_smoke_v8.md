...
Rows: 7
Input/output: `data/processed/timed_eval_stage33_hardfail_smoke_v8.jsonl`
...
- Answer quality flags: {'zero_ok_legal_sentences': 1, 'missing_next_step_section': 1, 'suppressed_sentences': 1}
...
| ---: | ---: | ---: | ---: | --- | --- |
| 17.0s | 16.6s | 0.0s | 0.1s | social_welfare_identity | I want to change my gender on aadhar and 10th certificate I have not had surgery is it pos |
...
| 4.9s | 4.5s | 0.0s | 0.2s | environment_compensation | iron ore mine displaced our 12 villages no rehabilitation given keonjhar |
| 4.7s | 4.4s | 0.0s | 0.2s | tribal_caste_atrocity | non tribal sahukar took my land in mortgage 15 years now refusing return jharkhand |
