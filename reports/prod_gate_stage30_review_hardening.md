...
Rows: 13
Input/output: `data/processed/timed_eval_stage30_review_hardening.jsonl`
...
| single_expanded_retrieval_ms | 1.8s | 2.1s | 5.8s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.2s | 0.2s |
| variant_rerank_ms | 3.3s | 3.7s | 9.0s |
| retrieval_ms | 5.1s | 5.8s | 14.9s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 15.2s | 14.9s | 0.0s | 0.2s | property_tenancy | my dad signed property to son under pressure when he was in icu can challenge |
| 6.2s | 5.9s | 0.0s | 0.2s | workplace_injury_compensation | site mukadam beat me head injury 8 stitches when i asked for old wages mumbai |
...
| 4.4s | 3.9s | 0.0s | 0.3s | family_marriage_status | how to legally change my surname after marriage, do i need to publish in gazette |
