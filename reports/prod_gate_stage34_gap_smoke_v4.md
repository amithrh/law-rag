...
Rows: 10
Input/output: `data/processed/timed_eval_stage34_gap_smoke_v4.jsonl`
...
| single_expanded_retrieval_ms | 2.1s | 2.9s | 7.2s |
...
| 6.6s | 6.2s | 0.0s | 0.2s | business_license_compliance | drug inspector picked up samples from my medical store schedule h sale without prescriptio |
...
| 5.2s | 4.9s | 0.0s | 0.2s | ibc_nclt | llp partner refusing to sign form 11 annual return 2 years pending strike off threat |
