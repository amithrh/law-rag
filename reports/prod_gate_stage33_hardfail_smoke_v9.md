...
Rows: 7
Input/output: `data/processed/timed_eval_stage33_hardfail_smoke_v9.jsonl`
...
| ---: | ---: | ---: | ---: | --- | --- |
| 15.4s | 15.2s | 0.0s | 0.1s | social_welfare_identity | I want to change my gender on aadhar and 10th certificate I have not had surgery is it pos |
| 5.9s | 5.6s | 0.0s | 0.2s | consumer | my neighbor is parking his car blocking my dedicated parking slot in apartment, security g |
| 5.8s | 5.4s | 0.0s | 0.2s | digital_platform_account | cab driver mumbai uber deactivated rating low because customer racist hindi speaker |
