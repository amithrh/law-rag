...
Rows: 7
Input/output: `data/processed/timed_eval_stage33_hardfail_smoke_v12.jsonl`
...
| single_expanded_retrieval_ms | 1.0s | 4.1s | 7.0s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.2s | 0.2s |
| variant_rerank_ms | 3.4s | 6.2s | 9.8s |
| retrieval_ms | 4.9s | 10.2s | 17.0s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 17.2s | 17.0s | 0.0s | 0.1s | social_welfare_identity | I want to change my gender on aadhar and 10th certificate I have not had surgery is it pos |
