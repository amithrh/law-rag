...
Rows: 4
Input/output: `data/processed/timed_eval_stage35_hardfail_seed2026052912.jsonl`
...
- Answer quality flags: {'suppressed_sentences': 2, 'missing_next_step_section': 1}
...
| single_expanded_retrieval_ms | 1.1s | 5.6s | 7.5s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.1s | 0.2s |
| variant_rerank_ms | 3.3s | 9.4s | 11.9s |
| retrieval_ms | 4.5s | 15.1s | 19.5s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 20.0s | 19.5s | 0.0s | 0.3s | social_welfare_identity | my caste certificate rejected by tehsildar I am SC how to appeal |
| 5.0s | 4.7s | 0.0s | 0.1s | digital_platform_account | lost 50k on dream11 like app is online rummy legal in tamil nadu |
| 4.7s | 4.3s | 0.0s | 0.2s | employment_wages | urban company beautician 3 strike system unfair termination labour law |
| 4.2s | 3.9s | 0.0s | 0.2s | succession_inheritance | parsi mother died in mumbai no will property between three sisters |
