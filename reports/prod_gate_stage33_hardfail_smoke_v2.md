...
Rows: 7
Input/output: `data/processed/timed_eval_stage33_hardfail_smoke_v2.jsonl`

## Outcome

- Refused: 0/7
- Errors: 0/7
- Relevance verdicts: {'ok': 5, 'off_topic': 1, 'partial': 1}
...
| single_expanded_retrieval_ms | 1.0s | 4.4s | 7.7s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.2s | 0.2s |
| variant_rerank_ms | 3.4s | 5.9s | 8.8s |
| retrieval_ms | 4.9s | 10.1s | 16.7s |
| prompt_build_ms | 0.0s | 0.0s | 0.0s |
| llm_stream_ms | 0.0s | 13.8s | 17.1s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 21.6s | 4.4s | 17.1s | 0.6s | tribal_caste_atrocity | non tribal sahukar took my land in mortgage 15 years now refusing return jharkhand |
| 17.4s | 5.7s | 11.6s | 0.3s | consumer | my neighbor is parking his car blocking my dedicated parking slot in apartment, security g |
| 17.0s | 16.7s | 0.0s | 0.1s | social_welfare_identity | I want to change my gender on aadhar and 10th certificate I have not had surgery is it pos |
| 5.7s | 5.4s | 0.0s | 0.2s | digital_platform_account | cab driver mumbai uber deactivated rating low because customer racist hindi speaker |
