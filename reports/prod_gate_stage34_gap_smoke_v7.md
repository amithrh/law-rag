...
Rows: 10
Input/output: `data/processed/timed_eval_stage34_gap_smoke_v7.jsonl`
...
| single_expanded_retrieval_ms | 2.1s | 2.8s | 6.5s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.1s | 0.2s |
| variant_rerank_ms | 3.7s | 4.5s | 9.3s |
| retrieval_ms | 5.6s | 7.1s | 16.0s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 16.4s | 16.0s | 0.0s | 0.2s | cyber_fraud_or_harassment | telegram channel leaked my onlyfans content without permission what to do |
...
| 5.3s | 4.9s | 0.0s | 0.3s | ibc_nclt | llp partner refusing to sign form 11 annual return 2 years pending strike off threat |
| 5.2s | 4.9s | 0.0s | 0.2s | senior_citizen | my father wants to know if registered gift deed to son can be cancelled if son not caring |
