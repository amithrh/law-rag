...
Rows: 13
Input/output: `data/processed/timed_eval_stage31_relevance_template_tuning.jsonl`
...
- Answer quality flags: {'suppressed_sentences': 1}
...
| single_expanded_retrieval_ms | 1.9s | 2.2s | 6.3s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.2s | 0.2s |
| variant_rerank_ms | 3.5s | 3.7s | 8.8s |
| retrieval_ms | 5.1s | 5.8s | 15.3s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 15.7s | 15.3s | 0.0s | 0.3s | workplace_injury_compensation | site mukadam beat me head injury 8 stitches when i asked for old wages mumbai |
...
| 6.0s | 5.7s | 0.0s | 0.2s | property_tenancy | my dad signed property to son under pressure when he was in icu can challenge |
| 5.8s | 5.4s | 0.0s | 0.2s | land_revenue_records | sarpanch giving common village land to his brother no panchayat meeting was held |
| 5.7s | 5.1s | 0.0s | 0.4s | business_contract_partnership | company hiding behind section 43B disallowance threat to delay my msme payment |
| 5.5s | 5.1s | 0.0s | 0.2s | criminal_general | daughter in law took my jewellery worth 12 lakh saying for safe keeping not returning agra |
| 5.5s | 5.0s | 0.0s | 0.3s | criminal_defence_bail | the spa was raided last week and police took me and other girls to station I just do massa |
| 5.3s | 4.9s | 0.0s | 0.2s | police_fir | i was undertrial 5 yrs released last week need help to file police torture case |
| 5.1s | 4.7s | 0.0s | 0.2s | banking_credit_dispute | cooperative bank seized my buffalo for crop loan default can they take livestock |
| 4.6s | 4.2s | 0.0s | 0.3s | criminal_defence_bail | false dacoity case lodged on my brother by forest guard for collecting tendu leaves dindor |
| 4.6s | 4.3s | 0.0s | 0.2s | consumer | society management has put a fine of 25000 on me for keeping a pet without prior approval, |
