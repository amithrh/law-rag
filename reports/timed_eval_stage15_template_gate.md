...
Rows: 8
Input/output: `data/processed/timed_eval_stage15_template_gate.jsonl`

## Outcome

- Refused: 0/8
- Errors: 0/8
- Relevance verdicts: {'ok': 5, 'partial': 3}
...
| retrieval_ms | 4.8s | 8.8s | 15.5s |
| prompt_build_ms | 0.0s | 0.0s | 0.0s |
| llm_stream_ms | 10.9s | 14.9s | 18.0s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 33.7s | 15.5s | 18.0s | 0.2s | bonded_labour_rescue | bonded labour my chacha working for thakur 12 years no wages just food bihar |
| 19.4s | 5.8s | 13.5s | 0.3s | criminal_defence_bail | passport seized in mumbai airport for vape cartridge cbd legal in goa |
| 18.4s | 4.6s | 13.6s | 0.2s | labour_exploitation_discrimination | girl child 12 helping mother in our migrant camp domestic work delhi is this illegal she i |
