...
Rows: 7
Input/output: `data/processed/timed_eval_stage33_hardfail_smoke_v5.jsonl`
...
| variant_rerank_ms | 3.4s | 5.9s | 9.0s |
| retrieval_ms | 4.9s | 9.5s | 15.3s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 15.6s | 15.3s | 0.0s | 0.1s | social_welfare_identity | I want to change my gender on aadhar and 10th certificate I have not had surgery is it pos |
| 5.9s | 5.6s | 0.0s | 0.1s | consumer | my neighbor is parking his car blocking my dedicated parking slot in apartment, security g |
