...
Rows: 13
Input/output: `data/processed/timed_eval_stage31_relevance_template_tuning_v2.jsonl`
...
| single_expanded_retrieval_ms | 1.9s | 2.5s | 6.0s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.2s | 0.2s |
| variant_rerank_ms | 3.4s | 3.7s | 8.3s |
| retrieval_ms | 5.2s | 5.9s | 14.5s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 14.9s | 14.5s | 0.0s | 0.2s | criminal_defence_bail | false dacoity case lodged on my brother by forest guard for collecting tendu leaves dindor |
| 6.4s | 6.0s | 0.0s | 0.3s | workplace_injury_compensation | site mukadam beat me head injury 8 stitches when i asked for old wages mumbai |
...
| 6.1s | 5.7s | 0.0s | 0.3s | family_marriage_status | how to legally change my surname after marriage, do i need to publish in gazette |
...
| 5.5s | 5.1s | 0.0s | 0.2s | criminal_defence_bail | the spa was raided last week and police took me and other girls to station I just do massa |
