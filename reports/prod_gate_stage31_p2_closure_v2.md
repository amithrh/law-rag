...
Rows: 13
Input/output: `data/processed/timed_eval_stage31_p2_closure_v2.jsonl`
...
| variant_rerank_ms | 3.5s | 3.8s | 9.9s |
| retrieval_ms | 5.3s | 5.8s | 16.8s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 17.2s | 16.8s | 0.0s | 0.2s | banking_credit_dispute | cooperative bank seized my buffalo for crop loan default can they take livestock |
...
| 5.8s | 5.5s | 0.0s | 0.2s | land_revenue_records | sarpanch giving common village land to his brother no panchayat meeting was held |
...
| 5.7s | 5.3s | 0.0s | 0.3s | criminal_general | daughter in law took my jewellery worth 12 lakh saying for safe keeping not returning agra |
...
| 5.5s | 5.1s | 0.0s | 0.3s | police_fir | i was undertrial 5 yrs released last week need help to file police torture case |
| 5.3s | 4.9s | 0.0s | 0.2s | workplace_injury_compensation | site mukadam beat me head injury 8 stitches when i asked for old wages mumbai |
| 5.2s | 4.8s | 0.0s | 0.2s | cyber_fraud_or_harassment | data breach at byjus my pan and aadhaar leaked, can i claim compensation under DPDP act |
| 4.8s | 4.4s | 0.0s | 0.2s | consumer | society management has put a fine of 25000 on me for keeping a pet without prior approval, |
| 4.5s | 4.0s | 0.0s | 0.3s | family_marriage_status | how to legally change my surname after marriage, do i need to publish in gazette |
