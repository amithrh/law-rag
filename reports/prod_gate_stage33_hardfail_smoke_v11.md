...
Rows: 7
Input/output: `data/processed/timed_eval_stage33_hardfail_smoke_v11.jsonl`
...
| ---: | ---: | ---: | ---: | --- | --- |
| 16.9s | 16.7s | 0.0s | 0.1s | social_welfare_identity | I want to change my gender on aadhar and 10th certificate I have not had surgery is it pos |
| 5.9s | 5.7s | 0.0s | 0.2s | consumer | my neighbor is parking his car blocking my dedicated parking slot in apartment, security g |
...
| 4.8s | 4.5s | 0.0s | 0.2s | tribal_caste_atrocity | non tribal sahukar took my land in mortgage 15 years now refusing return jharkhand |
