...
Rows: 13
Input/output: `data/processed/timed_eval_stage28_after_name_change_guidelines.jsonl`
...
| ---: | ---: | ---: | ---: | --- | --- |
| 15.9s | 15.6s | 0.0s | 0.2s | criminal_general | daughter in law took my jewellery worth 12 lakh saying for safe keeping not returning agra |
| 6.2s | 5.8s | 0.0s | 0.3s | workplace_injury_compensation | site mukadam beat me head injury 8 stitches when i asked for old wages mumbai |
...
| 5.5s | 5.3s | 0.0s | 0.1s | land_revenue_records | sarpanch giving common village land to his brother no panchayat meeting was held |
| 5.2s | 5.0s | 0.0s | 0.1s | family_marriage_status | how to legally change my surname after marriage, do i need to publish in gazette |
