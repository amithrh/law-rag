...
Rows: 13
Input/output: `data/processed/timed_eval_stage27_hardfail_after_regime_caveat.jsonl`
...
| single_expanded_retrieval_ms | 1.9s | 2.2s | 6.8s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.2s | 0.2s |
| variant_rerank_ms | 3.3s | 3.6s | 9.8s |
| retrieval_ms | 5.1s | 5.7s | 16.6s |
| prompt_build_ms | 0.0s | 0.0s | 0.0s |
| llm_stream_ms | 0.0s | 0.0s | 17.2s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 22.3s | 5.0s | 17.2s | 0.4s | family_marriage_status | how to legally change my surname after marriage, do i need to publish in gazette |
| 17.0s | 16.6s | 0.0s | 0.2s | cyber_fraud_or_harassment | data breach at byjus my pan and aadhaar leaked, can i claim compensation under DPDP act |
| 6.0s | 5.7s | 0.0s | 0.2s | banking_credit_dispute | cooperative bank seized my buffalo for crop loan default can they take livestock |
...
| 5.6s | 5.1s | 0.0s | 0.3s | business_contract_partnership | company hiding behind section 43B disallowance threat to delay my msme payment |
| 5.4s | 5.1s | 0.0s | 0.2s | criminal_defence_bail | false dacoity case lodged on my brother by forest guard for collecting tendu leaves dindor |
...
| 5.0s | 4.7s | 0.0s | 0.2s | workplace_injury_compensation | site mukadam beat me head injury 8 stitches when i asked for old wages mumbai |
...
| 4.3s | 3.9s | 0.0s | 0.2s | police_fir | i was undertrial 5 yrs released last week need help to file police torture case |
