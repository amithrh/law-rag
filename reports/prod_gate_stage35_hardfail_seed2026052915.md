...
Rows: 4
Input/output: `data/processed/timed_eval_stage35_hardfail_seed2026052915.jsonl`
...
| single_expanded_retrieval_ms | 1.0s | 5.9s | 8.0s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.1s | 0.2s |
| variant_rerank_ms | 3.3s | 9.5s | 12.2s |
| retrieval_ms | 4.3s | 15.5s | 20.2s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 20.6s | 20.2s | 0.0s | 0.2s | employment_wages | urban company beautician 3 strike system unfair termination labour law |
| 4.9s | 4.6s | 0.0s | 0.2s | digital_platform_account | lost 50k on dream11 like app is online rummy legal in tamil nadu |
| 4.4s | 4.0s | 0.0s | 0.3s | social_welfare_identity | my caste certificate rejected by tehsildar I am SC how to appeal |
