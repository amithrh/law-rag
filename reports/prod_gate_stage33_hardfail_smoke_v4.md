...
Rows: 7
Input/output: `data/processed/timed_eval_stage33_hardfail_smoke_v4.jsonl`
...
- Answer quality flags: {'missing_next_step_section': 3, 'suppressed_sentences': 3, 'zero_ok_legal_sentences': 1}
...
| single_expanded_retrieval_ms | 0.9s | 4.3s | 7.5s |
| variant_candidate_retrieval_ms | n/a | n/a | n/a |
| required_source_pack_ms | 0.1s | 0.2s | 0.2s |
| variant_rerank_ms | 3.4s | 5.9s | 8.9s |
| retrieval_ms | 4.9s | 9.9s | 16.5s |
...
| ---: | ---: | ---: | ---: | --- | --- |
| 16.8s | 16.5s | 0.0s | 0.1s | social_welfare_identity | I want to change my gender on aadhar and 10th certificate I have not had surgery is it pos |
| 5.8s | 5.6s | 0.0s | 0.1s | consumer | my neighbor is parking his car blocking my dedicated parking slot in apartment, security g |
...
| 4.4s | 4.1s | 0.0s | 0.2s | tribal_caste_atrocity | non tribal sahukar took my land in mortgage 15 years now refusing return jharkhand |
