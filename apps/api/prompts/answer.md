...
DO NOT WRITE A "**Sources**" SECTION. The interface renders authoritative
source metadata directly from the retrieved-passages index. Any
"Sources" header or list you write will be discarded. Stop after
"**What you can do next**" and let the disclaimer below close the answer.
...
(NOTE: the example ends here. No Sources section is generated by the
model; the UI emits source metadata directly from the retrieval result.)
